              ...
              <div>
                ...
                {mobileSubmenu === 'partagez' && (
                  <div className="ml-4 mt-2 space-y-1">
                    ...
                    <Link href="/gastronomie-art-de-la-table" className="block px-6 py-2 text-sm text-slate-600 hover:text-wine-gold hover:bg-gray-50 rounded-md transition-colors min-h-[44px] flex items-center" onClick={closeMobileMenu}>
                      Art de la table
                    </Link>
          ...
          {hoveredMenu === 'partagez' && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  <Link 
                    href="/gastronomie-art-de-la-table" 
                    className="block text-sm font-medium tracking-wide transition-colors text-slate-600 hover:text-slate-900 py-2 px-2 rounded focus:outline-none focus:ring-2 focus:ring-wine-gold focus:text-wine-gold min-h-[44px] flex items-center"
                    onClick={() => closeMenuImmediately()}
                  >
                    Art de la table
