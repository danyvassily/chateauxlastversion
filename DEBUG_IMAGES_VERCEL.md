...
ls -la public/photos-web-lastours/photos-general/repas-vins-lastours.jpg
...
- URL attendue : `/_next/image?url=/photos-web-lastours/photos-general/repas-vins-lastours.jpg&w=1920&q=75`

### 4. Tester l'Accès Direct aux Images

Tester l'accès direct aux images (si le déploiement le permet) :
```
https://chateauxlastversion-3s5yxi2u5-danyvassilys-projects.vercel.app/photos-web-lastours/photos-general/repas-vins-lastours.jpg
```
...
<Image
  ...
  onError={(e) => {
    ...
    console.error("Image src:", "/photos-web-lastours/photos-general/repas-vins-lastours.jpg");
  }}
  onLoad={() => {
