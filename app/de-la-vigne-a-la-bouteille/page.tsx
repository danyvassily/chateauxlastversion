...
export default function DeLaVigneALaBouteillePage() {
  return (
    <div className="min-h-screen relative bg-white" data-page="de-la-vigne-a-la-bouteille">
      ...
      <section className="py-16 lg:py-24 bg-slate-50 scroll-mt-20 mt-6 lg:mt-8">
        <div className={cn(SPACING.container)}>
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Button
                asChild
                className="min-h-[44px] px-8 py-6 text-base focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
              >
      ...
      <section className="py-24 lg:py-32 xl:py-40 relative z-10 bg-white mt-6 lg:mt-8">
